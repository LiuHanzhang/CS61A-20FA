# NOTE: Failed Q4. Q4 is solution from Q&A section. Finish Q11
...
def num_trees(n):
    ...
    *   *        *       *
    ...
    """
    # From n - 1 leaves to n leaves: turn a previous leaf into a node. 
    # There are n-1 leaves that can be turned, and each has num_trees(n-1) different shape
    if n == 1:
        return 1
    total = 0
    for n_left in range(1, n):
        n_right = n - n_left
        n_left_trees = num_trees(n_left)
        n_right_trees = num_trees(n_right)
