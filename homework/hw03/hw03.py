...
#NOTE: Did not complete extra questions
...
def balanced(m):
    ...
    """
    "*** YOUR CODE HERE ***"
    torque_balanced = (length(left(m)) * total_weight(end(left(m))) == length(right(m)) * total_weight(end(right(m))))
...
def replace_leaf(t, find_value, replace_value):
    ...
    """
    "*** YOUR CODE HERE ***"
    return tree(replace_value if label(t) == find_value and is_leaf(t) else label(t), [replace_leaf(b, find_value, replace_value) for b in branches(t)])
